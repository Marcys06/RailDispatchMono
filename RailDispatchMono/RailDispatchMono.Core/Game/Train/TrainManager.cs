...
public sealed partial class TrainManager
{
        ...
        float speed = 0f)
    {
        ...
        // The depot composition is stored as [L][W][W], but at the depot exit
        // the physical consist must be [W][W][L]. Reverse only the runtime copy;
        // never mutate the player's composition.
        ...
        // startPosition is the head spawn point for the runtime train.

...
internal sealed class MyraRailwayLineView
{
        ...
        Action close)
    {
        ...
        bulkRow1.Widgets.Add(new Label { Text = "TrackType: " + _trackType, Width = 180 });
        ...
        bulkRow2.Widgets.Add(new Label { Text = "LineClass: " + _lineClass, Width = 180 });
        ...
        bulkRow3.Widgets.Add(new Label { Text = "TractionSystem: " + _traction, Width = 180 });

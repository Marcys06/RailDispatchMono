...
namespace RailDispatchMono.Screens
{
    ...
    internal class MainMenuScreen : MenuScreen
    {
        ...
        private void SetLanguageText()
        {
            ...
            Title = "RailDispatchMono"; // TODO uncomment this if you want it to use Resources.MainMenu; instead
        }
        ...
        public override void LoadContent()
        {
            ...
            settingsManager ??= ScreenManager.Game.Services.GetService<SettingsManager<RailDispatchMonoSettings>>();
